    ...
    <div className="keen-slider__slide">
      <div className={cn("object_card")}>
        ...
        <div className={cn("object_content")}>
          ...
          <p className="flex justify-center mt-[5px] font-[Arsenal] font-normal text-[16px] leading-[20px] text-white">
          ...
          <button className="pt-[15px] pb-[17px] text-center bg-white absolute bottom-0 left-0 w-full rounded-b-[10px] z-50 font-bold font-[Arsenal] text-[20px] leading-[25px] text-[#757575]">
            Подробнее
          </button>
        </div>
      </div>
